...
GRANT MODIFY ON TABLE kaustavpaul_demo.zerobus_delta.zerobus_products_clean TO `<your-service-principal-client-id>`;
GRANT SELECT ON TABLE kaustavpaul_demo.zerobus_delta.zerobus_products_clean TO `<your-service-principal-client-id>`;

-- Verify the table is clean
DESCRIBE DETAIL kaustavpaul_demo.zerobus_delta.zerobus_products_clean;
SHOW TBLPROPERTIES kaustavpaul_demo.zerobus_delta.zerobus_products_clean;
