...
class ZerobusSdk:
    ...
    async def create_stream(
        ...
        if self.__host.startswith(("[::1]", "http://localhost", "http://[::1]")):
            channel = grpc.aio.insecure_channel(self.__host)
        else:
        ...
        stream = ZerobusStream(stub, table_properties, options)
    ...
    async def recreate_stream(self, old_stream: ZerobusStream) -> ZerobusStream:
        ...
        new_stream = await self.create_stream(old_stream._table_properties, old_stream._options)
