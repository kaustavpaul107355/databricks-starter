...
class StreamConfigurationOptions:
    ...
    def __init__(self, **kwargs):
        ...
        # Function to get the Zerobus token.
        self.token_factory: Optional[Callable[[], str]] = None

        # The URL of the Unity Catalog endpoint.
        self.unity_catalog_url: Optional[str] = None
...
def get_zerobus_token(
    ...
    """
    logger.info(f"TEODOR: {table_name}, {workspace_id}, {workspace_url}, {client_id}, {client_secret}")
